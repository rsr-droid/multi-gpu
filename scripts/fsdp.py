...
# Run this with FSDP with "accelerate launch scripts/fsdp.py" after having run "accelerate config"
...
# Due to LoRA training we don't need to shard all the layers of the model so we 
# wrap the modules/layers that are to be used during training
